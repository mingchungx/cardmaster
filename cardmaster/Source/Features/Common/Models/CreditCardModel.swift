...
struct CreditCard: Identifiable {
    ...
    var immersive: String // Should be one of those found in assets
...
extension CreditCard {
    static var immersionState: String = "Office"
